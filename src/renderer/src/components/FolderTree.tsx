    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-gray-800 flex-shrink-0">
        ...
        <button
          ...
          className={`p-1 rounded transition-colors ${searchOpen ? 'text-indigo-400 bg-indigo-900/30' : 'text-gray-500 hover:text-gray-300 hover:bg-gray-800'}`}
        >
      ...
      {/* Search / filter panel */}
      {searchOpen && (
        <div className="px-2 pt-2 pb-1.5 border-b border-gray-800 flex-shrink-0 space-y-1.5">
          {/* Text input */}
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-6 pr-6 py-1.5 bg-gray-800 border border-gray-700 rounded text-xs text-gray-100 placeholder-gray-600 focus:outline-none focus:border-indigo-500 transition-colors"
            />
            {query && (
...
function FolderRow({
  ...
  const countColor = isFiltered
    ...
    : (isSelected ? 'text-indigo-400' : isRoot ? 'text-gray-500' : 'text-gray-600')
    ...
    <div className="relative group">
      ...
      {menu && (
        ...
        >
          ...
          <button
            className={`w-full text-left px-3 py-1.5 transition-colors ${dirtyCount > 0 ? 'text-gray-200 hover:bg-indigo-600/40' : 'text-gray-600 cursor-default'}`}
          ...
          <button
            className={`w-full text-left px-3 py-1.5 transition-colors ${dirtyCount > 0 ? 'text-gray-200 hover:bg-red-900/40' : 'text-gray-600 cursor-default'}`}
            disabled={dirtyCount === 0}
