  ...
  const steps: Step[] = [
    {
      ...
      description: 'NAM Lab needs Python with neural-amp-modeler installed (≥ 0.12.3). Point Settings → Training to the python executable inside your NAM conda or venv environment.',
      done: !!settings.namPythonPath?.trim(),
