...
const api = {
  ...
  tone3000Search: (params: { query?: string; page?: number; pageSize?: number; gears?: string[]; sizes?: string[]; sort?: string; architecture?: string; platform?: string; format?: string; creators?: string[]; tags?: string[]; makes?: string[]; calibrated?: boolean; verified?: boolean }): Promise<{ ok?: boolean; data?: unknown; error?: string }> => ipcRenderer.invoke('tone3000:search', params),
  tone3000Trending: (gear?: string): Promise<{ ok?: boolean; data?: unknown; error?: string }> => ipcRenderer.invoke('tone3000:trending', gear),
  tone3000Latest: (): Promise<{ ok?: boolean; data?: unknown; error?: string }> => ipcRenderer.invoke('tone3000:latest'),
  tone3000Downloaded: (params: { page?: number; pageSize?: number; gear?: string }): Promise<{ ok?: boolean; data?: unknown; error?: string }> => ipcRenderer.invoke('tone3000:downloaded', params),
  ...
  tone3000Makes: (params?: { query?: string; sort?: string; maxPages?: number }): Promise<{ ok?: boolean; data?: string[]; error?: string }> => ipcRenderer.invoke('tone3000:makes', params ?? {}),
  tone3000Tags: (params?: { query?: string; sort?: string; maxPages?: number }): Promise<{ ok?: boolean; data?: string[]; error?: string }> => ipcRenderer.invoke('tone3000:tags', params ?? {}),
  tone3000SetFavorite: (toneId: number, favorite: boolean): Promise<{ ok?: boolean; favorite?: boolean; error?: string }> => ipcRenderer.invoke('tone3000:setFavorite', toneId, favorite),
