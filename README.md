...
⚠️ The app is currently unsigned (beta). macOS will show a Gatekeeper warning; Windows will show a SmartScreen prompt. Both are safe to bypass — [first-launch instructions →](docs/install.md)
...
- **Pack Info editor** — documentation sheet per amp pack with rich text description, equipment table, captures table, and PDF export
...
- **Training version report** — pivot table showing preset × capture coverage per folder
